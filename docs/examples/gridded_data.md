...
**Expected output:**
![Basic XY Plot](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/xy_plot_basic_temperature.png)
...
**Expected output:**
![Basic XY Plot (Column Sum)](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/xy_plot_vertical_sum.png)
...
**Expected output:**
![Basic XY Plot (Column Average)](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/xy_plot_vertical_avg.png)
...
**Expected output:**
![Basic XY Plot (at Specified Level)](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/xy_plot_vertical_levs.png)
...
**Expected output:**
![Projected Map](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/xy_plot_robinson_projection.png)
...
**Expected output:**
![Projected Map over CONUS](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/xy_plot_conus_lambert_projection.png)
...
**Expected output:**
![Time Series Plot](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/temperature_timeseries_basic.png)
...
**Expected output:**
![Time Series Plot](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/temperature_timeseries_at_nyc.png)
...
**Expected output:**
![Time Series Plot](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/temperature_timeseries_at_nyc_inC.png)
...
**Expected output:**
![Time Series Plot](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/temperature_timeseries_trendline.png)
...
**Expected output:**
![Time Series Plot](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/temperature_timeseries_rolling_window.png)
...
**Expected output:**
![Zonal Mean](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/temperature_zonal_mean.png)
...
**Expected output:**
![Vertical Profile](https://github.com/cacruz/eviz-dev/releases/download/docs-images-v0.9/temperature_profile.png)
