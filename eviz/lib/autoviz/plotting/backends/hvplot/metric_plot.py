...
class HvplotMetricPlotter(XYPlotter):
    ...
    def plot(self, config, data_to_plot):
        ...
        try:
            self.logger.info(
                "Using HoloViews QuadMesh instead of Image for irregularly sampled data"
            )
            ...
            quadmesh = hv.QuadMesh(
                (x_values, y_values, z_values), kdims=[x_dim, y_dim], vdims=[field_name]
            )
