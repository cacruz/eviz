        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    self.logger.info(
                        f"Loaded GRIB file using pynio engine: {file_path}"
                    )
                except ImportError:
                    self.logger.error(
                        "Neither cfgrib nor pynio is installed. Cannot read GRIB files."
                    )
                    raise ImportError(
                        "Neither cfgrib nor pynio is installed. Please install one of them to read GRIB files."
                    )
