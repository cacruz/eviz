...
class DataSourceFactory:
    ...
    @classmethod
    def register(cls, source_name: str, data_source_class: Type[GenericDataSource]) -> None:
        """
    ...
    @classmethod
    def create(cls, source_name: str, config_manager: ConfigManager) -> Optional[GenericDataSource]:
        """
        ...
        cls._logger.debug(f"Creating {data_source_class.__name__} for source '{source_name}'")
